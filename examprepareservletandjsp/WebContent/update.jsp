...
<form   align="center" action="updating.jsp" method="post" >
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control"  value="<%=resultSet.getString("role") %>"  name="password">
  </div>
   <div class="form-group">
    <label for="roll">STATUS</label>
    <input type="text" class="form-control"  placeholder="enter 1 if accept 0 if reject" name="password">
  </div>
